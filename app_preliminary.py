...
#    geojson = json.load(f)
df1 = pd.read_excel('data/kokusei_R2_v2.xlsx', sheet_name=0, index_col=None, skiprow=[0,1,2])
df2 = pd.read_excel('data/kokusei_R2_v2.xlsx', sheet_name=1, index_col=None, skiprow=[0,1,2])
st.write(df1)
st.write(df2)
